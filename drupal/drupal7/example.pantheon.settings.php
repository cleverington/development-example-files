...
if (file_exists(dirname(__FILE__) . '/site-settings.php')) {
  require_once(dirname(__FILE__) . '/site-settings.php');
}

// Local development configuration.
// Instance-specific configuration, such as database credentials can be placed
// in a separate file named local-settings.php. @see example.local-settings.php
// for boilerplate example.
...
// Views Data Export Configuration (if using)
